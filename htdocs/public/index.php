...
<html lang="en">
    <head>
        ...
        <meta name="description" content="APRS und LoRa Livekarte.APRS Karte.LoRa Karte. Google Maps APRS. APRS tracking and weather data.">
        <meta name="keywords" content="APRS, LoRa, map, Online Map, Google Maps APRS,tracking,Echtzeitkarte,live,wetter map,aprs wetter,APRS-IS,aprs karte,tracker,CWOP,144.800,144.390,Mhz,weather maps, aprs tracking, aprs frequenz, lora aprs">
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                options['defaultTimeLength'] = 15; // In minutes
        ...
        <div class="app-shell">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content" id="tdTopnavTimelength">
                    <a href="javascript:void(0);" id="tdTopnavTimelengthDefault" onclick="trackdirect.setTimeLength(15); $('#tdTopnavTimelength>a').removeClass('dropdown-content-checkbox-active'); $(this).addClass('dropdown-content-checkbox-active');" class="dropdown-content-checkbox">15 minutes</a>
